...
You can find a pdf copy of my resume [here](https://ellamorgan.ca/files/Ella_Morgan_Resume.pdf){:target="\_blank"}.
...
* NSERC Undergraduate Student Research Award, Summer 2021
  ...
  * Project page: [ellamorgan.ca/portfolio/1-dreamerv2-eval](https://ellamorgan.ca/portfolio/1-dreamerv2-eval){:target="\_blank"}
...
* NSERC Undergraduate Student Research Award, Summer 2020
  ...
  * Project page: [ellamorgan.ca/portfolio/2-gm-lstm](https://ellamorgan.ca/portfolio/2-gm-lstm){:target="\_blank"}
...
* NSERC Undergraduate Student Research Award, Summer 2019
  ...
  * Links to paper and code can be found here: [ellamorgan.ca/portfolio/3-pred-intervals](https://ellamorgan.ca/portfolio/3-pred-intervals){:target="\_blank"}
...
* Solving Puzzles with Reinforcement Learning, Winter 2022
  ...
  * Code: [github.com/ellamorgan/solving-puzzles-rl](https://github.com/ellamorgan/solving-puzzles-rl){:target="\_blank"}
...
* Academic Paper Replication, Fall 2021
  ...
  * Code: [github.com/ellamorgan/latplan-pytorch](https://github.com/ellamorgan/latplan-pytorch){:target="\_blank"}
...
* Evolving Finite Automata, Fall 2021
  ...
  * Code: [github.com/ellamorgan/evolving-automata](https://github.com/ellamorgan/evolving-automata){:target="\_blank"}
